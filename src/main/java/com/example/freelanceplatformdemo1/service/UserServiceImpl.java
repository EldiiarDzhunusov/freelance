...
import com.example.freelanceplatformdemo1.model.Role;
...
public class UserServiceImpl implements UserService {
    ...
    public User save(UserRegistrationDto registrationDto) {
        User user = new User(registrationDto.getFirstName(),
                ...
                passwordEncoder.encode(registrationDto.getPassword()),registrationDto.getSkills(), Arrays.asList(new Role("ROLE_USER")));
